...
`/review` skill aggregate findings, present user, apply accepted fixes. Sự kiện review ghi vào mục tiến độ của `docs/{feature}/CONTEXT_SUMMARY.md` (KHÔNG ghi gì vào chính doc được review):
