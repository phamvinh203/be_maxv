...
/**
 * Họ tên người dùng: chặn độ dài + xuống dòng. `hoTen` được nhúng nguyên văn vào email gửi từ địa chỉ
 * đã xác thực của hệ thống (chào mừng, báo admin có lời mời...). Không giới hạn thì thành kênh phát tán
 * nội dung tùy ý dưới danh nghĩa MaxV. Export để lời mời nhân viên (company.validator) dùng chung.
 */
export const hoTenRule = z
  .string()
  .trim()
  .min(1)
  .max(100)
