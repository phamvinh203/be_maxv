...
**Các field ĐÃ BỎ (không thêm lại):** `lang`/`tags`/`stale_reason` (diet đợt 1, 2026-07-11); `created` (git biết), `owner` + `changelog` (người thực hiện và lịch sử thay đổi sống ở mục tiến độ của `docs/{feature}/CONTEXT_SUMMARY.md`) — diet đợt 2, 2026-07-12.
