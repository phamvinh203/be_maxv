...
export const tonKhoConfig: ModuleConfig = {
  ...
  danhMuc: [
    { left:  { label: 'Danh mục hàng hóa, vật tư',                           path: '/ton_kho/danh_muc/hang_hoa' },
      right: { label: 'Danh mục phân nhóm hàng hóa, vật tư',                 path: '/ton_kho/danh_muc/phan_nhom' } },
    { left:  { label: 'Danh mục đơn vị tính',                                path: '/ton_kho/danh_muc/dvt' },
      right: { label: 'Danh mục quy đổi đơn vị tính',                        path: '/ton_kho/danh_muc/quy_doi_dvt' } },
    { left:  { label: 'Danh mục lô',                                         path: '/ton_kho/danh_muc/lo' },
      right: { label: 'Danh mục kho hàng',                                   path: '/ton_kho/danh_muc/kho' } },
    { left:  { label: 'Danh mục nhóm kho hàng',                              path: '/ton_kho/danh_muc/nhom_kho' },
      right: { label: 'Danh mục vị trí kho hàng',                            path: '/ton_kho/danh_muc/vi_tri_kho' } },
    { left:  { label: 'Danh mục mã giao dịch',                               path: '/ton_kho/danh_muc/ma_gd' },
