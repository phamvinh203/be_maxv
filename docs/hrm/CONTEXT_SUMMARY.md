...
**Tiến độ backend-engineer `to_khai_thue` (cập nhật 2026-09-15):** `OQ-tkt-02` đã chốt — áp biểu mới cho cả năm 2026 (dòng chính sách mốc 2026-01-01 + dòng luật cũ mốc 1900-01-01). Xong 6 bước đầu của lộ trình trong `doi-soat-ma-nhap-to-khai-thue.md`, chi tiết từng bước ở `work-log.md`:
...
| 6 | Tờ khai quý 05/KK-TNCN: xem (tự tạo khi đủ 3 tháng) · lịch sử kỳ · ghi đè · xuất Excel/PDF · tải lại file · bảng chi tiết · đánh dấu đã nộp (8 endpoint) + cổng quyền `E-tkt-014` cho cả sub-cụm | chưa commit |
