...
export function overviewDauRa(): InvoiceColumn<DisplayRow>[] {
  return [
    ...
    },
    {
      ...
      // các nút trên nó sinh ra file tên gì. Template chỉ khai chỗ đứng, nút bấm do `InvoiceListTabs`
      // render vì cần state của bảng. `webOnly` — nút không có nghĩa trong file Excel.
      key: "lienQuan",
...
export function detailDauRa(): InvoiceColumn<DetailRow>[] {
  return [
    ...
    { key: "maVt", header: "Mã VT", width: 12, webWidth: 95, value: (r) => r.maVt },
    {
      key: "tenHang",
      header: "Tên hàng hóa, dịch vụ",
      width: 30,
    ...
    { key: "dvt", header: "Đơn vị tính", width: 12, webWidth: 85, value: (r) => r.dvt },
    {
      key: "soLuong",
      header: "Số lượng",
      width: 12,
    ...
    { key: "maNt", header: "Đơn vị tiền tệ", width: 12, webWidth: 95, value: (r) => r.maNt },
    {
      key: "tyGia",
      header: "Tỷ giá",
      width: 12,
    ...
    { key: "ghiChu1", header: "Ghi chú 1", width: 12, webWidth: 120, value: (r) => r.ghiChu },
    {
      key: "hinhThucTt",
