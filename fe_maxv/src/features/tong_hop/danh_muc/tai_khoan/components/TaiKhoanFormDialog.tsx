...
export function TaiKhoanFormDialog({ open, mode, current, onClose }: Props): JSX.Element {
  ...
  function setField<K extends keyof TaiKhoanForm>(key: K, value: TaiKhoanForm[K]) {
  ...
  function handleSubmit(e: FormEvent) {
    ...
    if (mode === 'edit' && current) {
      update.mutate({ tk: current.tk, body: form }, { onSuccess: onClose, onError });
    } else {
