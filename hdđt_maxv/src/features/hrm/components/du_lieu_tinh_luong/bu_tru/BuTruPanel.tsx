...
export default function BuTruPanel() {
  ...
  // RVW-711: nhân viên có khoản ứng - bù trừ trong kỳ nhưng bị 3 ô lọc ẩn khỏi
  // bảng — dữ liệu vẫn tính vào lương, chỉ là không ai thấy để kiểm tra ở màn này.
  const soNgoaiBoLoc = demSoNgoaiBoLoc(nhanVien, adjustmentData);
  ...
  return (
    <Stack spacing={2.5}>
      ...
      <ThanhCongCuBangNhap
        ...
        nhanApDung="Áp dụng bù trừ"
        nhanQuanLy="Quản lý khoản bù trừ"
        canhBaoChuaApDung="Bảng ứng - bù trừ có nội dung chưa áp dụng"
      />
      ...
      <DanhSachBuTruCard
        ...
        isReadOnly={isReadOnly}
      />
      <CanhBaoNgoaiBoLoc soLuong={soNgoaiBoLoc} module="ứng - bù trừ" />
