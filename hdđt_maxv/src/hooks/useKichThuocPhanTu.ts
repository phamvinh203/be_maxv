 ...
 *
 * Ở `src/hooks/` (không nằm trong `features/hddt/`) vì nội dung hoàn toàn generic (không đụng gì
 * riêng của hóa đơn điện tử) và đang được dùng bởi nhiều feature khác nhau: `hddt`, `to_khai`,
 * `hrm` (RVW-A13, `docs/hrm/review-findings.md`).
 */
