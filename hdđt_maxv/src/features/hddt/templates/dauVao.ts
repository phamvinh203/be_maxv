...
/**
 * Bảng "Tổng quát" đầu vào — 22 cột trên web, 21 cột trong file Excel (cột "Chọn" là `webOnly`).
 ...
 * Cột chưa có nguồn dữ liệu trả `undefined` -> web hiện "—", file xuất để trống.
 */
export function overviewDauVao(): InvoiceColumn<DisplayRow>[] {
  return [
    ...
    { key: "sellerMst", header: "MST", width: 22, value: (r) => r.sellerMst },
    { key: "sellerTen", header: "Tên người bán", width: 36, value: (r) => r.sellerTen },
    {
      key: "tienChuaThue",
...
/**
 * Bảng "Chi tiết hóa đơn" đầu vào — 27 cột. 1 dòng = 1 dòng hàng hóa; thông tin hóa đơn lặp lại
...
export function detailDauVao(): InvoiceColumn<DetailRow>[] {
  return [
    ...
    { key: "sellerMst", header: "MST/người bán", width: 15, value: (r) => r.sellerMst },
    { key: "sellerTen", header: "Tên người bán", width: 32, value: (r) => r.sellerTen },
