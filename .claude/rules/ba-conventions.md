...
## 1. Author resolution (cho mục tiến độ CONTEXT_SUMMARY)

> Frontmatter KHÔNG còn field `owner` (diet 2026-07-12) — "ai làm gì, đợt nào" ghi trong mục tiến độ của `docs/{feature}/CONTEXT_SUMMARY.md`.
...
- Sau mỗi Write/Edit, **chính skill** cập nhật mục tiến độ trong `docs/{feature}/CONTEXT_SUMMARY.md` (ghi @author + việc vừa làm). KHÔNG có hook nào tự ghi log thay — đừng set env `CLAUDE_CHANGELOG_*`, không bên nào đọc.
