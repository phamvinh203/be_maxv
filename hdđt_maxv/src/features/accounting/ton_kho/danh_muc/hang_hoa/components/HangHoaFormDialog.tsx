            ...
            <tbody>
              <FRow label="Mã hàng" required>
                <input
                  ...
                  autoFocus
                  style={
                    mode === "edit" ? { ...fi, background: "#f0f0f0" } : fi
                  }
                />
              </FRow>
              <FRow label="Tên hàng" required>
                <input
                  value={form.ten_vt}
                  onChange={(e) => set("ten_vt", e.target.value)}
                  disabled={ro}
                  style={fi}
                />
              </FRow>
              <FRow label="Tên khác">
                <input
                  value={form.ten_vt2}
                  onChange={(e) => set("ten_vt2", e.target.value)}
                  disabled={ro}
                  style={fi}
                />
              </FRow>
          ...
          {TABS.map((t, i) => (
            <button
              ...
              style={{
                ...
                borderBottom:
                  tab === i ? "2px solid #1a5fa8" : "2px solid transparent",
                marginBottom: -2,
              }}
            >
              {t}
...
function FRow({
  ...
  return (
    <tr>
      ...
      <td style={{ verticalAlign: "middle", padding: "4px 0 4px 12px" }}>
        {children}
      </td>
    </tr>
  );
    ...
    <table style={tabTable}>
      ...
      <tbody>
        ...
        <FRow label="Cách tính giá">
          <select
            value={form.gia_ton}
            onChange={(e) => set("gia_ton", Number(e.target.value))}
            disabled={ro}
            style={fi}
          >
        ...
        <FRow label="Vị trí">
          <input
            ...
            onChange={(e) => set("ma_vi_tri", e.target.value)}
            disabled={ro}
            style={fi}
          />
        </FRow>
        ...
        <FRow label="Thuế nhập khẩu">
          <SelectField
            list={lk.thuenkList}
            value={form.ma_thue_nk}
            onChange={(v) => set("ma_thue_nk", v)}
            disabled={ro}
          />
        </FRow>
      </tbody>
...
function TabTaiKhoan({
  ...
  const [pickerField, setPickerField] = useState<keyof HangHoaForm | null>(
    null,
  );
  ...
  return (
    <>
      ...
      <TaiKhoanPickerDialog
        ...
        title={
          pickerLabel ? `Chọn ${pickerLabel.toLowerCase()}` : "Chọn tài khoản"
        }
    ...
    <table style={tabTable}>
      ...
      <tbody>
        <FRow label="Kiểu lô">
          <select
            value={form.kieu_lo}
            onChange={(e) => set("kieu_lo", Number(e.target.value))}
            disabled={ro}
            style={fi}
          >
        ...
        <FRow label="Cách xuất">
          <select
            value={form.cach_xuat}
            onChange={(e) => set("cach_xuat", Number(e.target.value))}
            disabled={ro}
            style={fi}
          >
        ...
        <FRow label="">
          <label
            style={{
              ...
              gap: 5,
              fontSize: 12.5,
              cursor: ro || !form.lo_yn ? "default" : "pointer",
            }}
          >
            <input
              type="checkbox"
              checked={form.tao_lo}
              onChange={(e) => set("tao_lo", e.target.checked)}
              disabled={ro || !form.lo_yn}
            />
      ...
      <tbody>
        ...
        <FRow label="Thể tích">
          <div style={{ display: "flex", gap: 6 }}>
            ...
            />
            <input
              value={form.dvtvolume}
              onChange={(e) => set("dvtvolume", e.target.value)}
              disabled={ro}
              style={{ ...fi, width: 80 }}
              placeholder="Đvt"
            />
        ...
        <FRow label="Khối lượng">
          <div style={{ display: "flex", gap: 6 }}>
            ...
            />
            <input
              value={form.dvtweight}
              onChange={(e) => set("dvtweight", e.target.value)}
              disabled={ro}
              style={{ ...fi, width: 80 }}
              placeholder="Đvt"
            />
