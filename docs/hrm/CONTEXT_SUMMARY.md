...
**Tiến độ backend-engineer `to_khai_thue` (cập nhật 2026-09-15):** `OQ-tkt-02` đã chốt — áp biểu mới cho cả năm 2026 (dòng chính sách mốc 2026-01-01 + dòng luật cũ mốc 1900-01-01). Xong 5 bước đầu của lộ trình trong `doi-soat-ma-nhap-to-khai-thue.md`, chi tiết từng bước ở `work-log.md`:
...
| 5 | Bảng tính thuế tháng: xem 2 nguồn / chốt / mở lại (3 endpoint), ADR-013 tầng tháng | chưa commit |
