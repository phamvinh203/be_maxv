...
export function AuthProvider({ children }: { children: ReactNode }): JSX.Element {
  ...
  // apiClient nằm ngoài React nên báo về đây qua callback (refresh thất bại = hết phiên hẳn).
  useEffect(() => {
    setAuthEventHandlers({ onExpired: resetSession });
  ...
  const value = useMemo<AuthContextValue>(
    ...
    [session, hydrating, login, logout],
  );
